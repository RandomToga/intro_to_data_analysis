...
Рассчитайте выборочное среднее арифметическое оценок студентов с точностью до одного знака после запятой (введите с разделителем ”,").'''
#выборочное среднее арифметическое оценок
...
linel = plt.axvline(mean, label=('Среднее арифметическое = '+str(round(mean, 1))),
